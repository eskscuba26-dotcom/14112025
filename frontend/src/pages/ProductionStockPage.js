...
export default function ProductionStockPage() {
  ...
  return (
    <div className=\"space-y-6\">
      <h1 className=\"text-3xl font-bold\">Üretim Stok</h1>
      ...
      <div>
        <Input
          placeholder=\"Ara (Kalınlık, En, Boy, Renk)...\"
          value={searchTerm}
      ...
      <div className=\"bg-blue-50 border border-blue-200 rounded-lg p-4\">
        <h3 className=\"font-semibold text-blue-900 mb-2\">ℹ️ Bilgilendirme</h3>
        <p className=\"text-sm text-blue-800\">
          Üretim Stok, Üretim Girişi'nden gelen ürünlerin Sevkiyat ve Kesilmiş Ürün işlemlerinden
          sonra kalan miktarını gösterir. Renk bilgisi de dahil edilmiştir.
        </p>
      </div>
    </div>
  );
